...
import { setupSvgBatchExporter } from './src/export/svgBatchExporter.js';
...
function initialize() {
  ...
  try {
    setupSvgBatchExporter();
    console.log('✓ SVG batch exporter setup');
  } catch (error) {
    console.warn('SVG batch exporter setup failed:', error.message);
  }
