...
export function setupCollapsibleSections(preserveState = false) {
  ...
  // Initialize: collapse everything except the sections marked data-default-open
  // (Canvas, Object, Projection stay open; the rest collapse).
  if (!preserveState) {
    document.querySelectorAll('.collapsible-section').forEach(section => {
      if (!section.hasAttribute('data-default-open')) {
